...
var parsedIntrospectionQuery = graphql_1.parse(graphql_2.introspectionQuery);
function introspectSchema(link, linkContext) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!link.request) {
                        link = makeRemoteExecutableSchema_1.fetcherToLink(link);
                    }
                ...
                case 1:
                    ...
                    if (introspectionResult.errors || !introspectionResult.data.__schema) {
                        ...
                        schema = graphql_2.buildClientSchema(introspectionResult.data);
