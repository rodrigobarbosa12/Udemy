...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_xhr__ = __webpack_require__(11);
/* @flow */
...
const listarUsuarios = async () => {
    try {
        const { data: { users } } = await __WEBPACK_IMPORTED_MODULE_0__utils_xhr__["a" /* default */].get('/users/');
        return users
    } catch (error) {
        alert(error);
    }
...
const cadastrarUsuario = async (dados) => {
    try {
        await __WEBPACK_IMPORTED_MODULE_0__utils_xhr__["a" /* default */].post('/users/', dados);
    } catch (error) {
        alert(error);
    }
};
...
const apagarUsuario = async (id) => {
    try {
        await __WEBPACK_IMPORTED_MODULE_0__utils_xhr__["a" /* default */].delete(`/users/${id}`);
    } catch (error) {
        alert(error);
    }
};
...
const editarUsuario = async (usuarios, dados) => {
    usuarios.forEach(async (usuario) => {
        try {
            await __WEBPACK_IMPORTED_MODULE_0__utils_xhr__["a" /* default */].put(`/users/${usuario._id}`, dados);
        } catch (error) {
            alert(error);
        }
    });
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_qs__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_qs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_qs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__headers_api__ = __webpack_require__(35);
...
const xhr = __WEBPACK_IMPORTED_MODULE_0_axios___default.a.create({
    baseURL: __WEBPACK_IMPORTED_MODULE_3__constants__["a" /* API */],
    headers: Object(__WEBPACK_IMPORTED_MODULE_2__headers_api__["a" /* default */])(),
...
/* harmony default export */ __webpack_exports__["a"] = (headersApi);
...
/* unused harmony export PAGINA_INICIAL */
